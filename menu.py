...
while place_order:
    ...
    if menu_category.isdigit():
        ...
        if int(menu_category) in menu_items.keys():
            ...
            menu_item_number = input("Type the item number you'd like to order: ")
            ...
            if menu_item_number.isdigit():
                ...
                if menu_item_number in menu_items.keys():
                    ...
                    print("That input isn't valid. Please enter a valid number for the quantity.")


                # Tell the customer they didn't select a menu option
            else:
                print("You didn't select a valid menu option. Please try again.")
    ...
    while True:
        ...
        if keep_ordering.lower() in ["y", "yes"]:
            ...
            place_order = False  
                ...
                # their order
            print("Thank you for your order! Here's a summary of what you ordered:")
                # Exit the keep ordering question loop
            break
        else: 
                # Tell the customer to try again
            print("Sorry, I didn't understand that. Please type 'Y' for Yes or 'N' for No.")
